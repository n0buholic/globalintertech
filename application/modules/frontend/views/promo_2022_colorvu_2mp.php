...
<section class="section" style="padding: 35vh 0; background-image: url(<?= base_url("assets/frontend/images/promo/colorvu.jpg") ?>); background-position: center center; background-size: cover; height: 100px;">
    <div class="top-logo">
        <img src="<?= base_url("assets/frontend/images/promo/hikvision_logo.svg") ?>">
    </div>
    <div class="container h-100 d-flex align-items-center">
        <div class="row g-5">
            <div class="col-md-12 d-grid align-content-center text-center text-md-start text-dark">
                <h1 class="display-6 fw-bold text-white">PROMO COLORVU HIKVISION 2MP 2022</h1>
                <p class="h5 text-white">Paket Promo ColorVu Hikvision 2MP 2022</p>
            ...
            <div class="col-12 text-center mt-5">
                <div class="row text-center g-4">
                    <div class="col-md-12 d-flex align-items-center justify-content-center">
                        <img class="w-100" src="<?= base_url("assets/frontend/images/promo/COLORVU_FEATURE.png") ?>">
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <ul>
                            ...
                            <li>
                                Setiap pembelanjaan Paket ColorVu Hikvision berhak mendapatkan Merchandise menarik dari Hikvision.
                            </li>
