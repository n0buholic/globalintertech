...
<section class="section" style="padding: 35vh 0; background-image: url(<?= base_url("assets/frontend/images/promo/background.jpg") ?>); background-position: center center; background-size: cover;">
    <div class="top-logo">
        <img src="<?= base_url("assets/frontend/images/promo/proview_logo.svg") ?>">
    </div>
            ...
            <div class="col-md-6 text-center text-md-start">
                <div class="row">
                    <div class="col-7 d-flex align-items-center">
                        <img class="w-100" src="<?= base_url("assets/frontend/images/promo/proview_bullet.png") ?>">
                    </div>
                    <div class="col-5 d-flex align-items-center">
                        <img class="w-100" src="<?= base_url("assets/frontend/images/promo/proview_dome.png") ?>">
                    </div>
                </div>
            </div>
            <div class="col-md-6 d-grid align-content-center text-center text-md-start text-dark">
                <h1 class="display-6 fw-bold">PROMO PROVIEW 2022</h1>
                <p class="text-muted h5">Paket Promo Proview 2022</p>
            ...
            <div class="col-12 text-center mt-5">
                <div class="row text-center g-4">
                    <div class="col-md-4 d-flex align-items-center justify-content-center">
                        <img class="w-100" src="<?= base_url("assets/frontend/images/promo/proview_dvr.png") ?>">
                    </div>
                    <div class="col-6 col-md-4 d-flex align-items-center justify-content-center">
                        <img class="w-100" src="<?= base_url("assets/frontend/images/promo/proview_bullet.png") ?>">
                    </div>
                    <div class="col-6 col-md-4 d-flex align-items-center justify-content-center">
                        <img class="w-100" src="<?= base_url("assets/frontend/images/promo/proview_dome.png") ?>" style="width: 65% !important; object-fit: contain;">
                    </div>
                </div>
            </div>
